...
import { useSignInFormFeature } from '@/features/auth/Signin/SigninFormFeature/hooks/useSigninFormFeature';
...
export const ForgetPasswordFeature = () => {
  const { t } = useTranslation('auth');
  const { isSubmitting, onSubmit } = useSignInFormFeature();
